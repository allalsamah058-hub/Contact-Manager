...
class ContactManagerPro(ctk.CTk):
    ...
    def show_add_form(self):
        ...
        self.phone_input = ctk.CTkEntry(form_frame, width=400, height=45, border_color="#C71585", validate='key', validatecommand=vcmd)
    ...
    def show_contact_list(self):
        ...
        for c in self.cursor.fetchall():
            ...
            info_text = f"{c[1].upper()}\n{c[2]}\n{c[3]}"
            ctk.CTkLabel(card, text=info_text, font=("Arial", 18, "bold"), text_color="#C71585", justify="left").pack(side="left", padx=25, pady=15)
